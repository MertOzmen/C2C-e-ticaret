            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form action="../setting/adminislem.php" method="POST" data-parsley-validate class="form-horizontal form-label-left">
                        ...
                        <a onclick="return confirm('Mağaza başvurusunu iptal etmek istiyormusunuz?')" class="btn btn-danger" href="../setting/adminislem.php?magazaonay=red&kullanici_id=<?php echo $kullanicicek['kullanici_id']; ?>">Başvuruyu İptal Et</a>
