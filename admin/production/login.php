...
<head>
  ...
  <title>Güvercin Seyahat Acentası</title>
    ...
    <div class="login_wrapper">
      <div class="animate form login_form">
        <section class="login_content">
          ...
          <form action="../setting/islem.php" method="POST">
            ...
            <div class="separator">
             ...
             ?>
              ...
              <div>
                <h1><i class="fa fa-paw"></i> Güvercin Seyahat</h1>
                <p>©2020 Güvercin Seyahat Acentası</p>
              </div>
            </div>
          </form>
