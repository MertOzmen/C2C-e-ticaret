        ...
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <form action="../setting/islem.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
              ...
              <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12">Ürün Tarih</label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input class="form-control col-md-7 col-xs-12" required="" name="urun_tarih" id="first-name" value="<?php echo $uruncek['urun_tarih']?>" type="date">
                                </div>
                            </div>
