                    ...
                    <div class="tab-pane fade active in" id="Personal">
                        ...
                        <div class="personal-info inner-page-padding">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label">Muvcut Fotğraf</label>
                                <div class="col-sm-9">
                                    <img width="250" src="<?php echo $uruncek['urunfoto_resimyol']; ?>">
                                </div>
                            </div>
                            ...
                            <input type="hidden" value="<?php echo $uruncek['urunfoto_resimyolu'] ?>" name="eski_yol">

                            <div class="form-group">
                                <label class="col-sm-3 control-label">Tarih</label>
                                <div class="col-sm-9">
                                    <input class="form-control" required="" name="urun_tarih" id="first-name" value="<?php echo $uruncek['urun_tarih']?>" type="date">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div align="right" class="col-sm-12">
                                    <button class="update-btn" name="magazaurunduzenle" id="login-update">Tur Düzenle</button>
