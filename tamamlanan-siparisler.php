            ...
            <div class="personal-info inner-page-padding"> 
              ...
              <table class="table table-striped">
                ...
                <tbody>
                  ...
                  where siparis.kullanici_idsatici=:kullanici_idsatici and siparis_detay.siparisdetay_onay=:onay  order by siparis_zaman DESC");
                  ...
                  <tr>
                    ...
                    <a onclick="return confirm('Ürünü Teslim Ediyorsunuz Bu İşlem Geri Alınamaz');" href="admin/setting/kullanici.php?urunteslim=ok&siparisdetay_id=<?php echo $sipariscek['siparisdetay_id'] ?>&siparis_id=<?php echo $sipariscek['siparis_id'] ?>"><button class="btn btn-warning btn-xs"> Teslim Et</button></a>
