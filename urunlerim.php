            ...
            <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
                ...
                <div class="settings-details tab-content">
                    <div class="tab-pane fade active in" id="Personal">
                        <h2 class="title-section">Turlarınız</h2>
                        <div class="personal-info inner-page-padding">
                            ...
                            <table class="table table-striped">
                                <thead>
                                    <tr>
                                        <th scope="col">#</th>
                                        <th scope="col">Tur Eklenme Tarihi</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php } else { ?>
                                                    ...
                                                    <a onclick="return confirm('Bu ürünü silmek istiyormusunuz? \n İşlem geri alınamaz...')" href="admin/setting/adminislem.php?urunsil=ok&urun_id=<?php echo $uruncek['urun_id'] ?>&urunfoto_resimyol=<?php echo $uruncek['urunfoto_resimyol'] ?>"><button class="btn btn-danger btn-xs">Sil</button></a>
