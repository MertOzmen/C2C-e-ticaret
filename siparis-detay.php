            ...
            <div class="personal-info inner-page-padding"> 
              ...
              <table class="table table-striped">
                ...
                <tbody>
                  ...
                  INNER JOIN kullanici ON kullanici.kullanici_id=siparis_detay.kullanici_idsatici where siparis.siparis_id=:siparis_detay_id ");
                  ...
                  while($sipariscek=$siparissor->fetch(PDO::FETCH_ASSOC)) { $say++;
                    ...
                    <tr>
                      ...
                      <a onclick="return confirm('Ürüne Onay Veriyorsunuz Bu İşlem Geri Alınamaz');"
                       href="admin/setting/kullanici.php?urunonay=ok&siparisdetay_id=<?php echo $sipariscek['siparisdetay_id'] ?>&siparis_id=<?php echo $sipariscek['siparis_id'] ?>">
