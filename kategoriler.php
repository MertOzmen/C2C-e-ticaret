                                        ...
                                        <div class="item-content">
                                            ...
                                            <div class="item-profile">
                                                <div class="profile-title">
                                                    <div class="img-wrapper"> <img width="36" height="36" style="border-radius: 32px;" class="img-responsive" src="<?php echo $kullanicicek['kullanici_magazafoto'] ?>" alt="profile"></div>
                                            ...
                                            while ($s < $toplam_sayfa) {
                                                ...
                                                if (!empty($_GET['kategori_id'])) {
                                                    ...
                                                    if ($s == $sayfa) { ?>
                                                        ...
                                                        <li><a style="background-color:white; color:#f3a006;" href="kategoriler?sayfa=<?php echo $s; ?>"><?php echo $s; ?></a></li>
