              ...
              <table class="table table-striped">
                ...
                <tbody>
                  ...
                  <?php 
                   ...
                   where mesaj.kullanici_gon=:id order by mesaj_okunma,mesaj_zaman DESC");
                  ...
                  <tr>
                    ...
                    <td><?php echo $mesajcek['kullanici_ad']." ".$mesajcek['kullanici_soyad'] ?></td>
                      ...
                      <td><a href="mesaj-detay?gidenmesaj=ok&mesaj_id=<?php echo $mesajcek['mesaj_id'] ?>&kullanici_gon=<?php echo $mesajcek['kullanici_gon'] ?>">
                      <button class="btn btn-primary btn-xs">Mesajı Oku</button></a></td>

                      <td><a onclick="return confirm('Bu mesajı silmek istiyormusunuz? \n İşlem geri alınamaz...')" 
                      href="admin/setting/kullanici.php?gidenmesajsil=ok&mesaj_id=<?php echo $mesajcek['mesaj_id'] ?>"><button class="btn btn-danger btn-xs">Sil</button></a></td>
