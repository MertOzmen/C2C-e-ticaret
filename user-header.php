...
if (basename($_SERVER['PHP_SELF'])==basename(__FILE__)) {
 ...
 <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 col-lg-push-3 col-md-push-4 col-sm-push-4">
                <div class="inner-page-main-body">
                    ...
                    <img src="<?php echo $kullanicicek['kullanici_mazaresim']; ?>" alt="product" class="img-responsive">
                    </div>                                
                    <div class="author-summery">
                        ...
                        <div class="single-item">
                            ...
                            <div class="item-details">
                               ...
                               $puansay=$db->prepare("SELECT COUNT(yorumlar.yorum_puan) as say, SUM(yorumlar.yorum_puan) as topla, yorumlar.*,urun.* FROM yorumlar 
                               INNER JOIN urun ON yorumlar.urun_id=urun.urun_id where urun.kullanici_id=:id");
