    ...
    <div class="footer-area-top">
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="footer-box">
                        ...
                        <ul class="corporate-address">
                            <li><i class="fa fa-map-marker" aria-hidden="true"></i><?php echo $ayarcek['ayar_adres'], " ", $ayarcek['ayar_ilce'], " / ", $ayarcek['ayar_il'] ?></li>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="footer-box">
                        <h3 class="title-bar-left title-bar-footer">Neden Bİz</h3>
                        <ul class="featured-links">
                            <li>
                                <ul>
                                    <li><a href="hakkimizda.php">Nasıl Yardım Edebiliriz</a></li>
                                    <li><a href="hakkimizda.php">Güvercin Mağaza Detayları</a></li>
